...
const ReceptorFile = () => {
  ...
  return <>
    <VerticalTitleCard title="Receptor file" tooltip="蛋白结构文件: PDB 格式。请提供包含目标蛋白的三维结构文件，确保文件完整且包含结合口袋的相关信息。">
      <div>
        <UploadCard
          description="Select or drag and drop receptor file here"
          uploadURL="/poseview/files/upload?source=receptor"
          accept={accept}
          fileList={receptorUploadFileList}

...
import GlobalInputFile from '@/app/(commonLayout)/utility/docking/Global/Result/GlobalInputFile'
type ResultProps = {
  isDisabled?: boolean
}
const Result = ({ isDisabled = true }: ResultProps) => {
  // eslint-disable-next-line react/jsx-key
  const contentList: ReactNode[] = [<GlobalInputFile />, <GlobalOutputFile />]
